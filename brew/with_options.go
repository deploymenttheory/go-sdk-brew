...
// ClientOption configures the Homebrew API transport at construction time.
// Pass one or more ClientOption values to NewClient.
type ClientOption = client.ClientOption

// WithBaseURL sets a custom base URL, overriding the default https://formulae.brew.sh.
